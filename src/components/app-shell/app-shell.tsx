    ...
    <div className="min-h-screen bg-cream">
      <div className="flex">
        ...
        <div className="min-w-0 flex-1 border-r border-line">
          <header className="sticky top-0 z-10 bg-cream/90 px-4 py-5 backdrop-blur md:px-10">
            <div className="flex items-center justify-between gap-4">
              ...
              <label className="hidden h-11 max-w-sm flex-1 items-center gap-3 rounded-xl border border-line bg-white/80 px-4 text-muted lg:flex">
              ...
              <div className="ml-auto flex items-center gap-2">
                <button className="grid size-9 place-items-center rounded-xl text-muted hover:bg-soft-green hover:text-green" aria-label="Notifications">
                  <Bell className="size-4 stroke-[1.8]" />
                </button>
                <button className="grid size-9 place-items-center rounded-xl text-muted hover:bg-soft-green hover:text-green" aria-label="Account">
                  <UserRound className="size-4 stroke-[1.8]" />
                </button>
                <button
                  className="grid size-9 place-items-center rounded-xl text-muted hover:bg-danger/5 hover:text-danger"
                  aria-label="Sign out"
