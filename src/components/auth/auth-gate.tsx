    ...
    return (
      <main className="grid min-h-screen place-items-center bg-cream px-4 py-10">
        <Card className="w-full max-w-xl p-6">
          <p className="text-xs font-extrabold uppercase tracking-[0.14em] text-green">Fam Things setup</p>
          <h1 className="mt-2 text-3xl font-black">Supabase is not connected</h1>
          <p className="mt-3 text-sm leading-6 text-muted">{configError}</p>
          <div className="mt-5 rounded-lg border border-line bg-cream p-4 font-mono text-sm leading-7">
